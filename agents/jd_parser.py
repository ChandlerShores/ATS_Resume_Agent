...
class JDParser:
    ...
    def extract_signals_local(self, jd_text: str) -> tuple[JDSignals, float]:
        ...
        try:
            ...
            if all_terms:
                try:
                    ...
                    vectorizer = TfidfVectorizer(
                        ngram_range=(1, 2), max_features=100, stop_words="english"
                    )
                    ...
                    logger.warn(stage="jd_parser", msg=f"TF-IDF processing failed: {e}")
            ...
            logger.warn(stage="jd_parser", msg=f"Local extraction failed: {e}")
